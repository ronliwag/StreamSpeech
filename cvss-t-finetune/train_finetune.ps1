# StreamSpeech CVSS-T Fine-tuning Script (PowerShell)
...
# Set Python path to include fairseq
$env:PYTHONPATH = "C:\Original Streamspeech - Copy\fairseq;$env:PYTHONPATH"

Write-Host "Starting StreamSpeech fine-tuning..."
Write-Host "Data directory: $DATA"
Write-Host "Model: $model"

python fairseq/train.py $DATA `
  --user-dir "C:\Original Streamspeech - Copy\researches\ctc_unity" `
  ...
  --save-dir "C:\Original Streamspeech - Copy\checkpoints\$model" `
